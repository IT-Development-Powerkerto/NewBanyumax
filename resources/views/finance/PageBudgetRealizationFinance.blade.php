    ...
    <div class="flex">
        ...
        <main class="w-screen">
            <div class="px-5 mt-5">
                ...
                <div class="">
                    <livewire:table.budgetingrealization-finance-admin />
                    <livewire:modal.add-budgeting-realization-finance-admin />
                </div>
