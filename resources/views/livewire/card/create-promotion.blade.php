<div >
    <div
        ...
        <div class="flex flex-row justify-between items-center w-full">
            <div class="mt-1 flex flex-col w-full">
                <h1 class="font-semibold text-xl antialiased text-white tracking-wide">Create Promotion</h1>
    ...
    <div class="h-max bg-white rounded-b-lg px-5 py-5 ">
        <div class="border-t border-black-200">
            <livewire:card.form-create-promotion />
            <livewire:table.list-promotion />
        </div>
    </div>
</div>