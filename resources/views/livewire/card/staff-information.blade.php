<div>
    <div class="px-6 py-3 flex flex-row justify-between items-center bg-white border rounded-t-lg">
        <div class="flex flex-row justify-between items-center w-full">
            <div class="">
            <h1 class="font-semibold text-lg antialiased text-black tracking-wide sm:text-base">Staff Information</h1>
            <div class="flex flex-row gap-2 py-2">
                <span class="font-medium text-sm text-zinc-400">10 Staff</span>
            </div>
        </div>
            ...
            <div class="flex flex-col gap-2 md:gap-0 md:flex-row w-max">
                ...
                <button
                    class="text-blue-400 text-xs h-max shadow bg-white hover:bg-gradient-to-r from-cyan-500 to-blue-500 border hover:text-white font-medium rounded-lg px-4 py-2 flex flex-row gap-2 items-center"
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center space-x-4">
                            <div class="flex-shrink-0">
                                <img class="w-20 h-max rounded-full" src="assets/img/team/team-1.png" alt="Ava image">
                            </div>
