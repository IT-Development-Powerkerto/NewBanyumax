            ...
            <div class="relative rounded-lg shadow bg-slate-100" >
                ...
                <div class="py-6 px-6 lg:px-8">
                    ...
                    <form class="space-y-6" enctype="multipart/form-data">
                        <div class="relative">
                            <input type="text"  wire:model.debounce.500ms="name" id="name" class="block px-4 py-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Product Name" required>
                            @error('name') <span class="text-red-500">{{ $message }}</span> @enderror
                        </div>
                        <div class="relative">
                            <input type="text" wire:model.debounce.500ms="sku" id="sku" class="block px-4 py-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="SKU" required>
                        ...
                        <div class="relative">
                            <input type="text" wire:model.debounce.500ms="product_link" id="product_link" class="block px-4 py-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="linkproduct" required>
                        </div>
                        <div class="relative">
                        ...
                        <div class="flex flex-row gap-3">
                            <button type="button" wire:click.prevent="store" data-modal-toggle="add-product" class="w-full text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-600 border focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center">Add Product</button>
                        </div>
                    </form>
                </div>
            </div>
