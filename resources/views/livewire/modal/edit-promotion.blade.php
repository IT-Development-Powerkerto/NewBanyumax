<div>
<!-- Main modal -->
<div id="edit-promotion" wire:ignore.self tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative rounded-lg shadow bg-slate-100" >
            <button type="button" class="absolute top-5 right-6 text-white bg-red-500 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-toggle="edit-promotion">
            ...
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6" action="#">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" wire:model.debounce.500ms="promotion_product_price" id="promotion_product_price" class="block px-4 py-2 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="0" required>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" wire:model.debounce.500ms="promotion_product_percent" id="promotion_product_percent" class="block px-4 py-2 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="0" required>
                        @error('promotion_product_percent') <span class="text-red-500">{{ $message }}</span> @enderror
                    </div>
                    <div class="relative">
                        <input type="number" disabled  wire:model.debounce.500ms="total_promotion" id="total_promotion" class="block px-4 py-2 w-full text-sm text-gray-900 bg-gray-200 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Total Promotion" required>
                    </div>
                    <div class="flex flex-row gap-3">
                        <button type="button" wire:click.prevent="updatePromotion({{$promotionId}})" data-modal-toggle="edit-promotion" class="w-full text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-600 border focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center">Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
