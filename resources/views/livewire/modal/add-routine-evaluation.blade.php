<!-- Main modal -->
<div id="add-routine-evaluation" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative rounded-lg shadow bg-slate-100">
            ...
            <div class="py-6 px-6 lg:px-8">
                ...
                <form class="space-y-6" action="#">
                    ...
                    <div class="relative">
                        <input type="time" name="time" wire:model.defer='time' id="time"
                            class="block px-4 py-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Time" required>
                    </div>
                    <div class="relative">
                        <textarea name="resistance" wire:model.defer='resistance' id="resistance"
                            class="block px-4 py-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Resistance" required></textarea>
                    </div>
                    <div class="relative">
                        <textarea name="solution" wire:model.defer='solution' id="solution"
                            class="block px-4 py-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
