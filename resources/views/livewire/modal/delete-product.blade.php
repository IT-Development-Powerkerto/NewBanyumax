            ...
            <div class="py-6 px-6 lg:px-8">
                <form class="space-y-6" action="#">
                    ...
                    <div class="flex flex-row gap-3">
                        ...
                        <button type="submit" class="w-full text-gray-400 font-medium rounded-xl text-sm px-5 py-2.5 text-center border-2" data-modal-toggle="delete-product">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
