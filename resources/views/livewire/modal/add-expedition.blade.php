<!-- Main modal -->
<div id="add-expedition" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative rounded-lg shadow bg-slate-100">
            <button type="button"
                ...
                data-modal-toggle="add-expedition">
            ...
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-base font-semibold text-gray-900 dark:text-white border-b pb-2">Add Expedition</h3>
                <form class="space-y-6" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="relative">
                        <input type="text" name="expedition-name" id="expedition-name"
                            ...
                            placeholder="Expedition Name" required>
                    </div>
                    <div class="relative">
                    ...
                    <div class="flex flex-row gap-3">
                        <button type="submit" wire:click='store'
                            class="w-full text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-600 border focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-xl text-sm px-5 py-2.5 text-center">Create</button>
                    </div>
                </form>
            </div>
        </div>
