<!-- Main modal -->
<div id="edit-companyinfo" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
        ...
        <div class="relative rounded-lg shadow bg-slate-100">
            <button type="button"
                ...
                data-modal-toggle="edit-companyinfo">
            ...
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-base font-semibold text-gray-900 dark:text-white border-b pb-2">Company Info</h3>
                <form class="space-y-6" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="relative">
                        <input type="text" name="company-info id="company-info
                    ...
                    <div class="relative">
                        <input type="text" name="initialcompany" id="initialcompany"
                            class="block px-4 py-2 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="Initial Company" required>
                    </div>
                    <div class="relative">
