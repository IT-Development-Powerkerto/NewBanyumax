<div>
                                ...
                                <div class="relative bg-slate-100 rounded-lg shadow">
                                    ...
                                    <div class="py-6 px-6 lg:px-8">
                                        ...
                                        <form class="space-y-6" action="#">
                                            <div class="relative">
                                                <input type="text" name="cs" wire:model.defer='cs' id="cs"
                                                    class="block px-4 py-2 w-full text-sm text-gray-900 bg-[#EEEEEE] rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                                    placeholder="CS" required disabled>
                                            </div>
                                            <div class="relative">
                                            ...
                                            <div class="relative">
                                                <input type="text" name="product" wire:model.defer='product' id="product"
                                                    class="block px-4 py-2 w-full text-sm text-gray-900 bg-[#EEEEEE] rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                                    placeholder="Product" required disabled>
                                            </div>
                                            <div class="relative">
    ...
    <div class="py-3 px-5 justify-between flex items-center border rounded-b-lg">
        ...
        <button id="dropdownDefault" data-dropdown-toggle="dropdownFilter"
            ...
            type="button"><svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
