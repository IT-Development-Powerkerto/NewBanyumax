<div>
    <div class="py-3 px-5 flex flex-row justify-between items-center bg-white border-t border-x rounded-t-lg">
        <div class="flex flex-row justify-between items-center w-full">
            <div class="">
                <h1 class="font-semibold text-xl antialiased text-black tracking-wide">CRM</h1>
                <div class="flex flex-row gap-2 py-2">
                    <span class="font-medium text-sm text-zinc-400">1000</span>
                </div>
            </div>
            <div>
