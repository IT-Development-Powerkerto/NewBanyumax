        ...
        <div class="flex flex-row justify-between items-center w-full">
            ...
            <div class="flex flex-col gap-2 md:gap-0 md:flex-row w-max">
                ...
                <button
                    ...
                    <span class="text-xs" >Add Promotion</span>
                </button>
            </div>
        </div>
    </div>
        ...
        <table class="w-full text-sm text-left">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b text-xs text-black">
                    ...
                    <td class="px-6 py-4">
                        <button type="button" class="bg-gray-200 py-1 px-3 rounded-lg flex flex-row" aria-expanded="false" type="button" data-dropdown-toggle="dropdownAction{{$promotion->id}}">
                           Action
                           <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                          </svg>
                        </button>
                        <div class="hidden text-base list-none bg-white rounded divide-y divide-gray-100 shadow" id="dropdownAction{{$promotion->id}}">
