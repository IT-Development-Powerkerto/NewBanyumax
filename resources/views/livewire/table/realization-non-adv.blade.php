...
<div class="px-6 py-3 flex flex-row justify-between items-center bg-white border rounded-t-lg">
    <div class="flex flex-row justify-between items-center w-full">
        <div class="">
            <h1 class="font-semibold text-xl antialiased text-black tracking-wide">Realization Non Adv</h1>
        ...
        <div class="flex flex-col gap-2 md:gap-0 md:flex-row w-max">
            ...
            <div class="mr-2 w-36 md:w-fit">
                ...
                <button
                    ...
                    type="button" data-modal-toggle="export-realization">
                    <i class="las la-print text-xl"></i>
                    <span>Export</span>
                </button>

                <!-- Main modal -->
                <div id="export-realization" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                        ...
                        <div class="relative bg-slate-100 rounded-lg shadow">
                            <button type="button"
                                ...
                                data-modal-toggle="export-realization">
    ...
    <table class="w-full text-sm text-left">
        ...
        <tbody>
            <tr class="bg-white border-b text-xs text-black">
                ...
                <td class="px-6 py-4">
                    <button
                        class="text-white text-sm py-2 px-4 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-600 shadow-sm rounded-lg">
                        <a href="#">Download</a>
                    </button>
                </td>
            </tr>
