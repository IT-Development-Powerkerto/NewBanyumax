...
<div class="px-6 py-3 flex flex-row justify-between items-center bg-white border border-x-2 border-t rounded-t-lg">
        ...
        <div class="flex flex-col gap-2 md:gap-0 md:flex-row w-max">
            ...
            <div class="mr-2 w-36 md:w-fit">
                ...
                <button
                    ...
                    type="button" data-modal-toggle="export-budreal-finance">
                    <i class="las la-print text-xl"></i>
                    <span>Export</span>
                </button>

                <!-- Main modal -->
                <div id="export-budreal-finance" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                        ...
                        <div class="relative bg-slate-100 rounded-lg shadow">
                            <button type="button"
                                ...
                                data-modal-toggle="export-budreal-finance">
            ...
            <button
                ...
                type="button" data-modal-toggle="add-budgeting-realization">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd"
                        d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z"
                        clip-rule="evenodd" />
                </svg>
                <span class="text-xs" >Budgeting Realization</span>
            </button>
        </div>
    </div>
</div>
