<div class="px-6 py-3 flex flex-col md:flex-row lg:flex-row justify-between items-center bg-white border rounded-t-lg">
    <div class="flex flex-row justify-between items-center w-full">
        <div class="">
            <h1 class="font-semibold text-lg antialiased text-black tracking-wide">Documents Files</h1>
        </div>
    </div>
        ...
        <tbody>
            <tr class="bg-white border-b text-xs text-black">
                <td class="flex items-center gap-2 px-6 py-4">
                    <span class="iconify text-orange-400"  data-width="20" data-height="20" data-icon="carbon:document-blank"></span></i>data-penjualan.xls
                </td>
                <td class="px-6 py-4">
                    December 27th, 2021 04:51 AM
                </td>
                <td class="px-6 py-4">
                    2 MB
                </td>
            ...
            <tr class="bg-white border-b text-xs text-black">
                <td class="flex items-center gap-2 px-6 py-4">
                    <span class="iconify text-orange-400"  data-width="20" data-height="20" data-icon="carbon:document-blank"></span></i>data-adv.xls
                </td>
                <td class="px-6 py-4">
                    December 25th, 2021 04:51 AM
                </td>
                <td class="px-6 py-4">
                    3 MB
                </td>
            ...
            <tr class="bg-white border-b text-xs text-black">
                <td class="flex items-center gap-2 px-6 py-4">
                    <span class="iconify text-orange-400"  data-width="20" data-height="20" data-icon="carbon:document-blank"></span></i>data-cs.xls
                </td>
                <td class="px-6 py-4">
                    December 25th, 2021 04:51 AM
                </td>
