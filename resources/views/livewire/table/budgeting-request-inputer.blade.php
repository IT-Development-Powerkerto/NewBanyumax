        ...
        <div class="flex flex-col gap-2 md:gap-0 md:flex-row w-max">
            ...
            <div class="mr-2 w-36 md:w-fit">
                ...
                <button
                    ...
                    type="button" data-modal-toggle="export-budgetreq-inputer">
                    <i class="las la-print text-xl"></i>
                    <span>Export</span>
                </button>

                <!-- Main modal -->
                <div id="export-budgetreq-inputer" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                        ...
                        <div class="relative bg-slate-100 rounded-lg shadow">
                            <button type="button"
                                ...
                                data-modal-toggle="export-budgetreq-inputer">
    ...
    <table class="w-full text-sm text-left">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b text-xs text-black">
                ...
                <td class="px-6 py-4">
                    <Span class="bg-red-100 w-96 text-red-500 py-2 px-4 font-semibold rounded-md">
                        Rejected
                    </Span> 
                </td>
            </tr>
