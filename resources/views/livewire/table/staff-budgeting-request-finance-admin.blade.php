<div class="py-5">
    <div class="mt-1 flex flex-col w-full py-5">
        <h1 class="font-semibold text-xl antialiased text-white tracking-wide" style="color: #7E8299">Staff Budgeting Request Service</h1>
            ...
            <tbody>
                <tr class="bg-white border-b text-xs text-black">
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="hidden list-none bg-white rounded divide-y divide-gray-100 shadow" id="dropdownActionBudgeting">
                            <ul class="py-1" aria-labelledby="dropdownActionBudgeting">
                                ...
                                <li>
                                    <a href="#" data-modal-toggle="delete-promotion" class="block py-2 px-4 text-xs text-gray-700 hover:bg-gray-100 ">Reject</a>
                                </li>
                                <li>
