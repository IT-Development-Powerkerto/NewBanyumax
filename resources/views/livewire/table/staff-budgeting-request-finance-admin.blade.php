<div class="py-5">
    <div class="px-6 py-3 flex flex-row justify-between items-center bg-white border rounded-t-lg">
        <div class="flex flex-row justify-between items-center w-full">
            <div class="">
                <h1 class="font-semibold text-xl antialiased text-black tracking-wide">Staff Budgeting Request</h1>
        ...
        <div class="flex flex-col gap-2 md:gap-0 md:flex-row w-max">
            ...
            <div class="mr-2 w-36 md:w-fit">
                ...
                <button
                    ...
                    type="button" data-modal-toggle="export-budgeting-req">
                    <i class="las la-print text-xl"></i>
                    <span>Export</span>
                </button>

                <!-- Main modal -->
                <div id="export-budgeting-req" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                        ...
                        <div class="relative bg-slate-100 rounded-lg shadow">
                            <button type="button"
                                ...
                                data-modal-toggle="export-budgeting-req">
        ...
        <table class="w-full text-sm text-left">
            ...
            <tbody>
                <tr class="bg-white border-b text-xs text-black">
                    ...
                    <td class="px-6 py-4">
                        Telecomunical Credit
                    </td>
                    <td class="px-6 py-4">
                        RP. 90.000
                    </td>
                    <td class="px-6 py-4">
                        <button data-dropdown-toggle="dropdownActionBudgeting"
                            class="flex text-xs bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-r hover:from-cyan-400 hover:to-blue-600 shadow-sm rounded-lg px-3 py-2 text-white">
                            Action<span class="iconify text-base" data-icon="dashicons:arrow-down-alt2"></span>
                        </button>
                        <div class="hidden list-none bg-white rounded divide-y divide-gray-100 shadow"
                            id="dropdownActionBudgeting">
                            <ul class="py-1" aria-labelledby="dropdownActionBudgeting">
                                <li>
                                    <a href="#" 
                                        class="block py-2 px-4 text-xs text-gray-700 hover:bg-gray-100">Approved</a>
                                </li>
                                <li>
                                    <a href="#" 
                                        class="block py-2 px-4 text-xs text-gray-700 hover:bg-gray-100 ">Reject</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="block py-2 px-4 text-xs text-gray-700 hover:bg-gray-100 ">Download</a>
                                </li>
                            </ul>
                        </div>
                    </td>
