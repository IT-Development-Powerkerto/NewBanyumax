    ...
    <div class="px-6 py-3 flex flex-row justify-between items-center bg-gradient-to-r from-cyan-500 to-blue-500 border rounded-t-lg"
        ...
        <div class="flex flex-row justify-between items-center w-full">
            <div class="mt-1 flex flex-col w-full">
                <h1 class="font-semibold text-xl antialiased text-white tracking-wide">Budgeting Req ADV<h1>
                <div class="flex flex-row gap-2">
                    <span class="text-gray-300 font-semibold text-sm">2 Request</span>
                </div>
            </div>
        </div>
        <input
        ...
        <table class="w-full text-sm text-left">
            ...
            <tbody>
                <tr class="bg-white border-b text-xs text-black">
                    ...
                    <td class="px-6 py-4">
                        <div>
                            ...
                            <button id="dropdownActionButton3" data-dropdown-toggle="dropdownAction3"
                ...
                <tr class="bg-white border-b text-xs text-black">
                    ...
                    <td class="px-6 py-4 " style="color: #7137e9">
                        Wait
                    </td>
                    <td class="px-6 py-4">
                        <div>
