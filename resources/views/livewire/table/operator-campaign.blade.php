<div style="w-full">
    <div class="mt-1 flex flex-col w-full">
        ...
        <div class="flex flex-row gap-2">
            <span class="text-gray-300 text-sm" style="color:#7E8299">1 Campaigns</span>
        </div>
    </div>
                ...
                <tr class="bg-white border-b text-xs text-black">
                    ...
                    <td class="px-6 py-4">
                        <div class=" flex flex-col">
                            <span class="text-xs text-semibold">39 Leads</span>
                            <span class="text-xs text-gray-400">1 Daily Lead</span>
                        </div>
                    </td>
                    <td class="px-6 py-4">
                        <div class=" flex flex-col">
