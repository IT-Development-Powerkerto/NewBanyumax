<div class="px-6 py-3 flex flex-row justify-between items-center bg-white border-t border-x rounded-t-lg">
    <div class="flex flex-row justify-between items-center w-full">
        <div class="">
            <h1 class="font-semibold text-xl antialiased text-black tracking-wide">Admin</h1>
            <div class="flex flex-row gap-2 py-2">
                <span class="font-medium text-sm text-zinc-400">1000 Data</span>
            </div>
        </div>

        <div class="flex flex-col gap-2 md:gap-2 md:flex-row w-max">
            <div class="relative">
            ...
            <div class="w-36 md:w-fit">
                <button
                    class="text-gray-400 shadow w-full bg-white hover:bg-gradient-to-r from-cyan-500 to-blue-500 border hover:text-white font-medium rounded-lg text-sm px-4 py-2 text-center flex flex-row justify-center items-center gap-2"
                    type="button" data-modal-toggle="export-admin">
                    <i class="las la-print text-xl"></i>
                    <span>Export</span>
                </button>
                {{-- modals export --}}
                <div id="export-admin" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                        ...
                        <div class="relative bg-slate-100 rounded-lg shadow">
                            <button type="button"
                                ...
                                data-modal-toggle="export-admin">
            ...
            <div class="w-36 md:w-fit">
                <button
                    class="hover:text-gray-400 hover:from-white hover:to-white shadow w-full bg-gradient-to-r from-cyan-500 to-blue-500 border text-white font-medium rounded-lg text-sm px-4 py-2 text-center flex flex-row justify-center items-center gap-2"
                    type="button" data-modal-toggle="add-admin">
    ...
    <table class="w-full text-sm text-left">
        ...
        <tbody>
            <tr class="bg-white border-b text-xs text-black">
                ...
                <td class="px-6 py-4">
                    <button id="dropdownActionButton3" data-dropdown-toggle="action-admin"
                        class="flex bg-gray-300 shadow-sm rounded-lg px-3 py-1 text-gray-600 text-sm"
                        type="button">Action<svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
