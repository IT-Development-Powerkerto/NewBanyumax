<div>
    <div class="px-6 py-3 flex flex-row justify-between items-center bg-white border rounded-t-lg">
        <div class="flex flex-row justify-between items-center w-full">
            <div class="">
            <h1 class="font-semibold text-lg antialiased text-black tracking-wide sm:text-base">Announcement</h1>
            <div class="flex flex-row gap-2 py-2">
                <span class="font-medium text-sm text-zinc-400">10 Announcement</span>
            </div>
        </div>
            ...
            <div class="flex flex-col gap-2 md:gap-0 md:flex-row w-max">
                ...
                <button
                    ...
                    type="button" data-modal-toggle="add-announcement-on-admin">
